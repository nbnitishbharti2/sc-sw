				...
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<div class="col-md-2 text-right">
							<a href="{!! route('view.category') !!}" class="btn btn-success"><i class="fa fa-arrow-left"></i> &nbsp; {{trans('button.back')}}</a>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
								...
								<form role="form" action="{{ $action }}" method="POST">
									...
									<div class="card-body">
										...
										<div class="card-footer">
						                  	...
						                  	<a href="{{ route('view.category') }}" class="btn btn-success">{{trans('button.back')}}</a>
						                </div>
									</div>
									<!-- /.card-body -->
								</form>
