				...
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<div class="col-md-2 text-right">
							<a href="{!! route('view.hostel-fee') !!}" class="btn btn-success"><i class="fa fa-arrow-left"></i> &nbsp; {{trans('button.back')}}</a>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
									...
									<div class="card-body">
				                        ...
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-sm-4">
												...
												<input type="hidden" id="fee_head_id" class="form-control" name="fee_head_id" value="3" readonly />
												<input type="text" id="head-name" class="form-control" name="head_name" value="{{trans('label.hostel')}}" readonly />
										...
										<div class="form-group row">
											<div class="col-sm-4" id="amount">
												<label for="amount">{{trans('label.amount')}}</label>
												<input type="text" name="amount" id="amount" class="form-control" placeholder="{{trans('placeholder.amount')}}" value="{{ ($amount) ? $amount : old('amount') }}">	
										...
										<div class="card-footer">
						                  	...
						                  	<a href="{{ route('view.hostel-fee') }}" class="btn btn-success">{{trans('button.back')}}</a>
						                </div>
									</div>
									<!-- /.card-body -->
								</form>
