<!-- Navbar -->
      ...
      <li class="dropdown dropdown-user">
          ...
          <ul class="dropdown-menu dropdown-menu-default pull-left">
            <li class="user-menu-pull-left">
              ...
              <a href="{{ route('user-profile') }}"> <i class="icon-key"></i>Profile</a>
            </li>
            <li class="user-menu-pull-left">
            ...
            <li class="user-menu-pull-left">
              ...
              <a href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> <i class="icon-key"></i>{{ __("Log Out") }}</a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/home') }}" class="brand-link">
      <img src="{{ asset('public/dist/img/AdminLTELogo.png') }}" alt="School" class="brand-image img-circle elevation-3"
           style="opacity: .8">
